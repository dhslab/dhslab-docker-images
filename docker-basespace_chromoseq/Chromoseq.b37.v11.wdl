workflow ChromoSeq {
  ...
  String GenesBed 
  String Cytobands = "/gscmnt/gc2555/spencer/dhs/projects/chromoseq/b37_files/b37.cytoBand.bed.gz"
  String SVDB = "/gscmnt/gc2555/spencer/dhs/projects/chromoseq/b37_files/B37.callset.public.bedpe.gz"
  
  String MantaConfig = "/opt/files/configManta.hg38.py.ini"
  
  String Reference = "/gscmnt/gc2737/ding/Reference/hs37d5_plusRibo_plusOncoViruses_plusERCC.20170530.fa"
  String ReferenceIndex = "/gscmnt/gc2737/ding/Reference/hs37d5_plusRibo_plusOncoViruses_plusERCC.20170530.fa.fai"
  String ReferenceBED = "/gscmnt/gc2555/spencer/refdata/GRCh37/all_sequences.bed.gz"
  String VEP = "/gscmnt/gc3042/cle_validation/myeloseq_haloplex/VEP_cache"

  String tmp = "/tmp"

  String gcWig = "/usr/local/lib/R/site-library/ichorCNA/extdata/gc_hg19_500kb.wig"
  String mapWig = "/usr/local/lib/R/site-library/ichorCNA/extdata/map_hg19_500kb.wig"
  String Centromeres = "/usr/local/lib/R/site-library/ichorCNA/extdata/GRCh37.p13_centromere_UCSC-gapTable.txt"
  String PON = "/gscmnt/gc2555/spencer/dhs/projects/chromoseq/b37_files/nextera.wgs.500kb.median_normAutosome_mapScoreFiltered_median.rds_median.rds"
...
#  }
  ...
  call combine_variants {
    input: VCFs=[run_varscan.varscan_snv_file,run_varscan.varscan_indel_file],
    Bam=Cram,
    BamIndex=CramIndex,
    refFasta=Reference,
    Name=Name,
...
task run_ichor {
  ...
  command <<<
    ...
    --txnE 0.999999 --txnStrength 1000000 --genomeStyle NCBI --outDir ./ --libdir /usr/local/bin/ichorCNA/ && \
    mv ${Name}/*.pdf .
  >>>
...
task annotate_svs {
  ...
  command {
    ...
    /opt/conda/envs/python2/bin/bcftools concat -a -O v cnv.vcf.gz filtered.tagged.reheader.vcf.gz | \
